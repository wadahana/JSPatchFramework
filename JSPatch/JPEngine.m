...
extern const unsigned char JSPatch_js[];
...
static id<JPEngineDelegate> _delegate = nil;
#ifdef DEBUG
...
+ (void)setDelegate: (id<JPEngineDelegate>) delegate {
    _delegate = delegate;
}
...
//    NSString *jsCore = [[NSString alloc] initWithData:[[NSFileManager defaultManager] contentsAtPath:path] encoding:NSUTF8StringEncoding];
    NSString *jsCore = [NSString stringWithUTF8String:JSPatch_js];
